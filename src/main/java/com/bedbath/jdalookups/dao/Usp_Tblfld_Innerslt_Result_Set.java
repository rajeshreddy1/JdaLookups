...
public class Usp_Tblfld_Innerslt_Result_Set  extends StoredProcedure {

	@SuppressWarnings("rawtypes")
	public Usp_Tblfld_Innerslt_Result_Set(JdbcTemplate jdbcTemplate) {
		
		super(jdbcTemplate, "Usp_Tblfld_Innerslt_Result_Set");
	...
	public Map getResults(String action, String keyValue,String searchValue, String searchDescription, String ignoreBlankValue, String sortField, int start, int limit, String server) {
