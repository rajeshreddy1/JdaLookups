...
public class Usp_Tblfld_Pcrsn_Result_Set  extends StoredProcedure {

	@SuppressWarnings("rawtypes")
	public Usp_Tblfld_Pcrsn_Result_Set(JdbcTemplate jdbcTemplate) {
		
		super(jdbcTemplate, "Usp_Tblfld_Pcrsn_Result_Set");
		
		RowMapper rowMapper = new TblFldRowMapper();//using same rowmapper of Usp_Tblfld_Result_Set
