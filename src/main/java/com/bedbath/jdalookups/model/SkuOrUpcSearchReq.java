...
public class SkuOrUpcSearchReq {
	...
	private int retailTo;
	private int mapFrom;
	private int mapTo;
	private int msrpFrom;
	private int msrpTo;
	...
	public int getRetailTo() {
		return retailTo;
	}
	public void setRetailTo(int retailTo) {
	...
	public int getMsrpFrom() {
		return msrpFrom;
	}
	public void setMsrpFrom(int msrpFrom) {
		this.msrpFrom = msrpFrom;
	}
	public int getMsrpTo() {
		return msrpTo;
	}
	public void setMsrpTo(int msrpTo) {
		this.msrpTo = msrpTo;
	}
