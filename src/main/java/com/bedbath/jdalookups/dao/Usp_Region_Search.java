...
public class Usp_Region_Search  extends StoredProcedure {

	@SuppressWarnings("rawtypes")
	public Usp_Region_Search(JdbcTemplate jdbcTemplate) {
		
		super(jdbcTemplate, "Usp_Region_Search");
		
		RowMapper rowMapper = new RegionRowMapper();
