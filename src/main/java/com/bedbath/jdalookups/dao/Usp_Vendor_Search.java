...
public class Usp_Vendor_Search  extends StoredProcedure {

	@SuppressWarnings("rawtypes")
	public Usp_Vendor_Search(JdbcTemplate jdbcTemplate) {
		
		super(jdbcTemplate, "Usp_Vendor_Search");
		
		RowMapper rowMapper = new VendorRowMapper();
		...
		declareParameter(new SqlParameter("p_vendor_Name" , Types.VARCHAR));
		declareParameter(new SqlParameter("p_vendor_Type" , Types.CHAR));
		declareParameter(new SqlParameter("p_scac_Code" , Types.CHAR));
	...
	public Map getResults(int vendorNumber,String vendorName, String vendorType, String scacCode, String sortFields, String existenceColumn, String appendToWhereClause, int start, int limit, String server) {
		
		Map inParms = new HashMap();

		inParms.put("p_vendor_Number"        , vendorNumber);
		inParms.put("p_vendor_Name"          , vendorName);
		inParms.put("p_vendor_Type"          , vendorType);
		inParms.put("p_scac_Code"            , scacCode);
