...
public class Usp_Bbsappvalu_Maintenance  extends StoredProcedure {
	...
	public Usp_Bbsappvalu_Maintenance(JdbcTemplate jdbcTemplate) {
		...
		declareParameter(new SqlParameter("p_num_Value_2_String" , Types.VARCHAR));
		declareParameter(new SqlParameter("p_num_Value_2_StrLen" , Types.NUMERIC));
	...
	public Map getResults(String action, String updateKeys, String updateFields, String applicationKey, String charValue1, String charValue2, String charValue3, Long numValue1, Long numValue2, Long numValue3, String documentPath, String note1, String note2, String sequenceName, String user, String server) {
		...
		inParms.put("p_num_Value_2_String" ,     "");
		inParms.put("p_num_Value_2_StrLen" ,     0);
	...
	// Multiple rows @ once - used for store or other entity list
	@SuppressWarnings({"unchecked","rawtypes"})
	public Map getResults(String action, String updateKeys, String updateFields, String applicationKey, String charValue1, String charValue2, String charValue3, Long numValue1, String numValue2String, int numValue2Length, Long numValue3, String documentPath, String note1, String note2, String sequenceName, String user, String server) {
		...
		inParms.put("p_char_Value_3"       ,     charValue3); 
		inParms.put("p_numeric_Value_1"    ,     numValue1);  
		inParms.put("p_numeric_Value_2"    ,     0); 
		inParms.put("p_num_Value_2_String" ,     numValue2String);
		inParms.put("p_num_Value_2_StrLen" ,     numValue2Length);
		inParms.put("p_numeric_Value_3"    ,     numValue3); 
		inParms.put("p_document_Path"      ,     documentPath);   
		inParms.put("p_note_1"             ,     note1);   
		inParms.put("p_note_2"             ,     note2);
